    ...
    <div>
      ...
      <div className='grid grid-cols-2 mt-5 md:grid-cols-3 lg:grid-cols-5 gap-5'>
        {Options.map((option,index)=>(
           <div key={index} className={`p-4 flex flex-col items-cenetr justify-center border rounded-xl hover:border-blue-600 cursor-pointer ${option?.name==SelectedOption&& 'border-blue-600'}`}
